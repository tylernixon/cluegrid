...
export function ModalShell({
  ...
  const modalContent = (
    ...
    >
      ...
      <div
        className="absolute inset-x-0 top-0 h-[72px] pointer-events-none bg-gradient-to-b from-canvas dark:from-black to-transparent"
      />
      <div
        className="absolute inset-x-0 bottom-0 h-[72px] pointer-events-none bg-gradient-to-t from-canvas dark:from-black to-transparent"
      />
