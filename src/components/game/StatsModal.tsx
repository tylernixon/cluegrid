    ...
    <Modal open={open} onClose={onClose} title="Statistics">
      <div className="flex flex-col flex-1">
        ...
        <div className="mt-auto pt-6">
          <button
            type="button"
            className="w-full px-6 py-3 bg-surface-raised/80 dark:bg-surface-raised-dark/80 backdrop-blur-sm text-ink dark:text-ink-dark border border-border dark:border-border-dark rounded-xl font-semibold text-body hover:bg-surface-raised dark:hover:bg-surface-raised-dark transition-all active:scale-[0.98]"
            onClick={onClose}
